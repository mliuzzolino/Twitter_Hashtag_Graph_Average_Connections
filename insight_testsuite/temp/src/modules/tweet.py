...
class Tweet(object):
    ...
    def __init__(self, tweet_json):
        """ 
        Initializes tweet object from tweet_json
            Obtains timestamp and hashtags via clean_tweet_json and
            returns True if tweet has timestamp, 
            else returns false and ignores new tweet
        """
    ...
    def __repr__(self):
        """
        Represents tweet object as timestamp followed by hashtags within tweet
        """
